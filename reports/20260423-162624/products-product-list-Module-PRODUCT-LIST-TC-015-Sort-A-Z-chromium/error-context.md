...
- Name: products\product-list.spec.js >> Module PRODUCT LIST >> TC-015: Sort A-Z
- Location: tests\products\product-list.spec.js:20:7

# Error details

```
TypeError: Cannot read properties of undefined (reading 'NameAZ')
```
