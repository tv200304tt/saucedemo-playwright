...
- Name: checkout\checkout.spec.js >> Module CHECKOUT – 13 Test Cases (incl. Data-Driven) >> TC-048: Cancel step 2 (Overview) → về Inventory
- Location: tests\checkout\checkout.spec.js:61:7
