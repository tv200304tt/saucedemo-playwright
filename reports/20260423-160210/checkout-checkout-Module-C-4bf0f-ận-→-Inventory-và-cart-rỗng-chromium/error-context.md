...
- Name: checkout\checkout.spec.js >> Module CHECKOUT – 13 Test Cases (incl. Data-Driven) >> TC-052: Back Home sau xác nhận → Inventory và cart rỗng
- Location: tests\checkout\checkout.spec.js:110:7
