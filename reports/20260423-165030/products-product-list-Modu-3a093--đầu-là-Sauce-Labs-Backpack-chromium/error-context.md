...
- Name: products\product-list.spec.js >> Module PRODUCT LIST – 10 Test Cases >> TC-015: Sort A→Z – item đầu là Sauce Labs Backpack
- Location: tests\products\product-list.spec.js:27:7
